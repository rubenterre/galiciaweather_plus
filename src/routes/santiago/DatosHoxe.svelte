		...
		axios
			...
			.then((data) => {
				...
				function cambiarSoleado() {
					return './santiago/fondo_soleado.png';
				}

                function cambiarNoiteClara(){
					return './santiago/fondo_noite_clara.png';

                }

                function cambiarSoleadoPoucasNubes(){
					return './santiago/fondo_soleado_poucas_nubes.png';

                }

                function cambiarNoitePoucasNubes(){
					return './santiago/fondo_noite_poucas_nubes.png';

                }

                function cambiarDiaNublado(){
					return './santiago/fondo_nublado.png';

                }

                function cambiarNoiteNublada(){
					return './santiago/fondo_noite_nublado.png';
                ...
                function cambiarMoitaChoiva(){
					return './santiago/fondo_moita_choiva.png';

                }

                function cambiarPoucaChoiva(){
					return './santiago/fondo_pouca_choiva.png';

                }

                function cambiarTormenta(){
					return './santiago/fondo_tormenta.png';

                }

                function cambiarNeve(){
					return './santiago/fondo_neve.png';

                }

                function cambiarNeboa(){
					return './santiago/fondo_neboa.png';

                }

                function cambiarColorDia(){
					return './santiago/unknown.png';
