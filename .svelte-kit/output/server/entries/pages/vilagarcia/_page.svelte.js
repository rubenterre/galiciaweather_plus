...
const css = {
  code: ".posicion.svelte-vwq8rc{position:relative;z-index:10}.datosTecnicos.svelte-vwq8rc{background:#0d1b2a;padding-bottom:80px}.caixas.svelte-vwq8rc{background:#1b263b;border:1px solid #415a77;border-radius:12px;text-align:center;margin:20px}img.svelte-vwq8rc{width:50px;padding-top:20px}p.svelte-vwq8rc{font-family:SFProText-Medium;font-size:12px;color:#e0e1dd;letter-spacing:1px;text-align:center}h4.svelte-vwq8rc{font-family:SFProText-Medium;font-size:18px;color:#ffffff;letter-spacing:1px;text-align:center}",
  map: null
};
const DatosTecnicos = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(DatosHoxe, "DatosHoxe").$$render(
    ...
    {},
    {}
  )} <div class="posicion svelte-vwq8rc">${validate_component(PorHoras, "PorHoras").$$render($$result, { TiempoHoras: forecastData }, {}, {})} ${validate_component(PorDias, "PorDias").$$render($$result, { TiempoDias: forecastDias }, {}, {})}</div> <div class="datosTecnicos svelte-vwq8rc"><div class="row"><div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/temperMax.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-m2md8">Temp. Max.</p> <h4 class="svelte-vwq8rc">${escape(tempmax)}ºC</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/temperMin.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-4a7uba">Temp. Min.</p> <h4 class="svelte-vwq8rc">${escape(tempmin)}ºC</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/wind.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-1xiwqsg">Vento</p> <h4 class="svelte-vwq8rc">${escape(wind)} km/h</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/feel_like.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-1b66wfj">Sensación</p> <h4 class="svelte-vwq8rc">${escape(feel)} ºC</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/humidity.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-tsib6v">Humidade</p> <h4 class="svelte-vwq8rc">${escape(humidity)} %</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/pressure.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-4v31ok">Presión</p> <h4 class="svelte-vwq8rc">${escape(pressure)} hPa</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/uvi.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-1nk0d9r">Indice UV</p> <h4 class="svelte-vwq8rc">${escape(uvi)}/10</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/visibilidad.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-18vrm1t">Visibilidade</p> <h4 class="svelte-vwq8rc">${escape(visibilidad)} m</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/sunrise.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-llqjzt">Amancer</p> <h4 class="svelte-vwq8rc">${escape(amancer)}</h4></div> <div class="col s6 caixas svelte-vwq8rc"><img src="./iconos/sunset.png" alt="" class="svelte-vwq8rc"> <p class="svelte-vwq8rc" data-svelte-h="svelte-1lz7hxp">Solpor</p> <h4 class="svelte-vwq8rc">${escape(solpor)}</h4></div></div> </div>`;
});
