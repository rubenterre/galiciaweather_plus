...
const css$3 = {
  code: ".fechaLugar.svelte-1tpgona.svelte-1tpgona{text-align:center;margin-top:40px}.fechaLugar.svelte-1tpgona h4.svelte-1tpgona{font-family:SFProText-Bold;font-size:18px;color:#ffffff;letter-spacing:1.29px;text-align:center;text-shadow:0 2px 4px rgba(0, 0, 0, 0.5)}.fechaLugar.svelte-1tpgona p.svelte-1tpgona{font-family:SFProText-Bold;font-size:14px;color:#ffffff;letter-spacing:1.29px;text-align:center;text-shadow:0 2px 4px rgba(0, 0, 0, 0.5)}.temperaturaTiempo.svelte-1tpgona.svelte-1tpgona{margin-bottom:40px}.temperaturaTiempo.svelte-1tpgona h1.svelte-1tpgona{font-family:SFProText-Medium;font-size:74px;color:#ffffff;letter-spacing:1px;text-align:center;text-shadow:0 2px 4px rgba(0, 0, 0, 0.5);position:relative;z-index:4}.temperaturaTiempo.svelte-1tpgona p.svelte-1tpgona{font-family:SFProText-Medium;font-size:14px;color:#ffffff;letter-spacing:1.17px;text-align:center;text-shadow:0 2px 4px rgba(0, 0, 0, 0.5);position:relative;z-index:4}.datos.svelte-1tpgona.svelte-1tpgona{margin-bottom:20px}.datos_capsula.svelte-1tpgona.svelte-1tpgona{position:relative}.datos_capsula.svelte-1tpgona.svelte-1tpgona::before{content:'';position:absolute;top:0;left:0;width:100%;height:100%;background-image:url('./datos_capsula.svg');background-repeat:no-repeat;background-size:contain;z-index:2}.datos_pills.svelte-1tpgona.svelte-1tpgona{text-align:center;z-index:3}.datos_pills.svelte-1tpgona p.svelte-1tpgona{font-family:SFProText-Medium;font-size:12px;color:#e0e1dd;letter-spacing:1px;text-align:center}.datos_pills.svelte-1tpgona h4.svelte-1tpgona{font-family:SFProText-Medium;font-size:18px;color:#ffffff;letter-spacing:1px;text-align:center;margin-top:5px}.datos_pills.svelte-1tpgona p.svelte-1tpgona{color:#e0e1dd}.fondo.svelte-1tpgona.svelte-1tpgona{background-size:cover;background-repeat:no-repeat;z-index:-2}.cidades_img.svelte-1tpgona.svelte-1tpgona{position:absolute;top:32%;left:50%;transform:translate(-50%, -50%);z-index:1}.cidades_img.svelte-1tpgona img.svelte-1tpgona{background-size:cover;width:100vw}",
  map: null
};
