...
const css = {
  code: ".posicion.svelte-3iuudu{position:relative;z-index:10}.datosTecnicos.svelte-3iuudu{background:#0d1b2a;padding-bottom:80px}.caixas.svelte-3iuudu{background:#1b263b;border:1px solid #415a77;border-radius:12px;text-align:center;margin:20px}img.svelte-3iuudu{width:50px;padding-top:20px}p.svelte-3iuudu{font-family:SFProText-Medium;font-size:12px;color:#e0e1dd;letter-spacing:1px;text-align:center}h4.svelte-3iuudu{font-family:SFProText-Medium;font-size:18px;color:#ffffff;letter-spacing:1px;text-align:center}",
  map: null
};
const DatosTecnicos = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(DatosHoxe, "DatosHoxe").$$render(
    ...
    {},
    {}
  )} <div class="posicion svelte-3iuudu">${validate_component(PorHoras, "PorHoras").$$render($$result, { TiempoHoras: forecastData }, {}, {})} ${validate_component(PorDias, "PorDias").$$render($$result, { TiempoDias: forecastDias }, {}, {})}</div> <div class="datosTecnicos svelte-3iuudu"><div class="row"><div class="col s6 caixas svelte-3iuudu"><img src="./iconos/temperMax.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-m2md8">Temp. Max.</p> <h4 class="svelte-3iuudu">${escape(tempmax)}ºC</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/temperMin.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-4a7uba">Temp. Min.</p> <h4 class="svelte-3iuudu">${escape(tempmin)}ºC</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/wind.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-1xiwqsg">Vento</p> <h4 class="svelte-3iuudu">${escape(wind)} km/h</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/feel_like.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-1b66wfj">Sensación</p> <h4 class="svelte-3iuudu">${escape(feel)} ºC</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/humidity.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-tsib6v">Humidade</p> <h4 class="svelte-3iuudu">${escape(humidity)} %</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/pressure.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-4v31ok">Presión</p> <h4 class="svelte-3iuudu">${escape(pressure)} hPa</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/uvi.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-1nk0d9r">Indice UV</p> <h4 class="svelte-3iuudu">${escape(uvi)}/10</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/visibilidad.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-18vrm1t">Visibilidade</p> <h4 class="svelte-3iuudu">${escape(visibilidad)} m</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/sunrise.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-llqjzt">Amancer</p> <h4 class="svelte-3iuudu">${escape(amancer)}</h4></div> <div class="col s6 caixas svelte-3iuudu"><img src="./iconos/sunset.png" alt="" class="svelte-3iuudu"> <p class="svelte-3iuudu" data-svelte-h="svelte-1lz7hxp">Solpor</p> <h4 class="svelte-3iuudu">${escape(solpor)}</h4></div></div> </div>`;
});
